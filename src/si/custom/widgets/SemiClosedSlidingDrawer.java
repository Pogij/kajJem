	...
	extends ViewGroup
{
	...
	protected void onFinishInflate()
	{
		...
		/* 
		 * Changed by Matevž Pogačar
		 * Change: from 'mContent.setVisibility(View.VISIBLE);' to 'mContent.setVisibility(View.GONE);' 
		 */
	...
	/** 
	 * Modified by Matevž Pogačar
	 * 
	 * Changed from 'private void closeDrawer()' to 'public void closeDrawer()'
	 **/
	...
	@SuppressLint("HandlerLeak") private class SlidingHandler
		extends Handler
	{
